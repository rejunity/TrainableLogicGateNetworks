...
DATASET = config.get("DATASET", "MNIST") # MNIST, FashionMNIST, KMNIST, QMNIST, EMNIST, CIFAR10
# TODO: SVNH (RGB 32x32, 10 classes?), STL10 (RGB 96x96)
...
HAMMING_DICTIONARY = config.get("HAMMING_DICTIONARY", "0").lower() in ("true", "1", "yes")
